...
define('SITE_TITLE','PorcoRossoPress');
define('SITE_DESC','porco rosso press blog');
define('GRAV_EMAIL','admin@porcorosso.press');
define('SITE_URL','http://localhost/single-file/sedotpress-master');
